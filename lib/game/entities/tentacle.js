    ...
    EntityTentacle = ig.Entity.extend({
        ...
        init: function (x, y, settings) {
            ...
            switch (this.tentacleIndex) {
                case 1:
                    this.animSheet = new ig.AnimationSheet("media/sprites/tentacleSprite1.png", 106, 86);
                    this.addAnim('tentacleLower', 1, [0, 1, 2, 3, 4, 3, 2, 1, 0], true);
                    this.addAnim('tentacleUpper', 1, [0, 1, 5, 6, 5, 1, 0], true);
                    break;
                case 2:
                    this.animSheet = new ig.AnimationSheet("media/sprites/tentacleSprite2.png", 47, 96);
                    this.addAnim('tentacle', 1, [0, 1, 2, 3, 4, 5, 4, 3, 2, 1, 0], true);
                    this.addAnim('grabbed', 1, [6], true);
                    break;
                case 3:
                    this.animSheet = new ig.AnimationSheet("media/sprites/tentacleSprite3.png", 28, 74);
                    this.addAnim('tentacle', 1, [0, 1, 2, 3, 4, 3, 2, 1, 0], true);
                    break;
                case 4:
                    this.animSheet = new ig.AnimationSheet("media/sprites/tentacleSprite4.png", 43, 57);
                    this.addAnim('tentacle', 1, [0, 1, 2, 3, 2, 1, 0], true);
                    break;
            }
        ...
        update: function () {
            ...
            if (this.deathTimer != null && this.deathTimer.delta() > 5 && ig.game.lives > 0) {
        ...
        animateTentacle: function () {
            ...
            if (rndNumber == 2) {
                ...
                this.currentAnim.frameTime = ig.game.octopus.tentacleSpeed;
